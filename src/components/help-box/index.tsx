...
export const HelpBox: React.FC = () => {
  ...
  const customerRoles: string[] = ['Congregation Member'];
  const tenantRoles: string[] = ['Administrator', 'Staff Member', 'Volunteer'];
  const addOns: string[] = ['chat', 'notifications', 'file'];
  const applicationName = `FaithHub`;
  const tenantName = `Church`;
